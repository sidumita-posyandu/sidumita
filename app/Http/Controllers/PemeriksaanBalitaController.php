...
class PemeriksaanBalitaController extends Controller
{
    public function index(Request $request)
    {
        ...
        ->withToken($request->session()->get('token'))
        ->get(env('BASE_API_URL').'dusun')
        ->json();
        $dusun = $response2['data'];
                
        return view('pemeriksaanbalita.index',compact('pemeriksaanbalita', 'dusun'));
    }
    ...
    public function createWithId(Request $request, $id)
    {
        ...
        $response3 = Http::accept('application/json')
        ->withToken($request->session()->get('token'))
        ->get(env('BASE_API_URL').'umur/'.' '.$balita['detail_keluarga_id'])->json();
        $umur = $response3['data'];
    ...
    public function store(Request $request)
    {
        ...
        ->withToken($request->session()->get('token'))
        ->get(env('BASE_API_URL').'balita/'.' '.$request->balita_id)->json();
        $cekBalita = $responseBalita['data'];

        $responseUmur = Http::accept('application/json')
        ->withToken($request->session()->get('token'))
    ...
    public function show(Request $request, $id)
    {
        $response = Http::accept('application/json')
        ->withToken($request->session()->get('token'))
        ->get(env('BASE_API_URL').'pemeriksaan-balita/'.' '.$id)->json();
    ...
    public function rekap_balita(Request $request, $id)
    {
        ...
        $response3 = Http::accept('application/json')
        ->withToken($request->session()->get('token'))
        ->get(env('BASE_API_URL').'umur/'.' '.$rekap[0]['balita']['detail_keluarga_id'])->json();
        $umur = $response3['data'];
        ...
        // $tinggi_badan = [NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL];
        // $berat_badan = [NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL];
        // $lingkar_kepala = [NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL];
