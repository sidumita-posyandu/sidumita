        ...
        <div class="row">
            <div class="col-6">
                <div class="container">
                    <div class="row">
                        <h6>NIK :</h6>
                        <h6 class="ml-3">{{ $ibuhamil['nik'] }}</h6>
                    </div>
                    <div class="row">
                        <h6>Nama Ibu Hamil : </h6>
                        <h6 class="ml-3">{{ $ibuhamil['nama_lengkap'] }}</h6>
                    </div>
                    <div class="row">
                        <h6>Jenis Kelamin : </h6>
                        <h6 class="ml-3">{{ $ibuhamil['jenis_kelamin'] }}</h6>
                    </div>
                    <div class="row">
            ...
            <div class="col-6">
                <div class="row">
                    ...
                    <h6 class="ml-3">{{ $ibuhamil['tempat_lahir'] }} / {{ $ibuhamil['tanggal_lahir'] }}</h6>
                </div>
                <div class="row">
                    <h6>Kepala Keluarga :</h6>
                    <h6 class="ml-3">{{ $ibuhamil['keluarga']['kepala_keluarga'] }}</h6>
                </div>
                <div class="row">
                    <h6>Golongan Darah :</h6>
                    <h6 class="ml-3">{{ $ibuhamil['golongan_darah'] }}</h6>
                </div>
                <div class="row">
                    <h6>Dusun :</h6>
